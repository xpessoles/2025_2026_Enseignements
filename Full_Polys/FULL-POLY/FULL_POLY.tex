...
\newcommand{\auteur}{Xavier Pessoles -- \url{https://xpessoles.github.io/}}
\newcommand{\repRel}{../../..}
...
\author[XP]{Xavier Pessoles et plein d'autres ...}
\date{\today}
...
\begin{center}
%\dedication{Merci à ma petite famille, qui partage ma vie. }
\large
Merci à ma petite famille, qui partage ma vie. 
\normalsize
\end{center}
\vspace*{\stretch{1}}
...
\input{11_tec}
\input{12_revisions_statique_01}
\input{12_revisions_statique_02}
\input{12_revisions_statique_03}
\input{14_revisions_cinematique}
%%
%\blindtext
%
